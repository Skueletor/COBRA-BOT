...
const PP_DESC = ""
cobra.addCommand({pattern: 'setwelcome$', fromMe: true, desc: PP_DESC, dontAddCommandList: true}, (async (message, match) => {    
    if (!message.reply_message || !message.reply_message.video) return await message.client.sendMessage(message.jid,NEED_PHOTO, MessageType.text);
    ...
    await uploadByBuffer(fs.readFileSync(location), 'video/mp4')
    .then(async(result) => {
                const {
              link,
              path,              
...
await heroku.patch(baseURI + '/config-vars', { 
    ...
    await message.client.sendMessage(message.jid, '*' + SUCC_SETWELCOME + '*', MessageType.text)
    })
}));
cobra.addCommand({pattern: 'setbye$', fromMe: true, desc: PP_DESC, dontAddCommandList: true}, (async (message, match) => {    
    if (!message.reply_message || !message.reply_message.video) return await message.client.sendMessage(message.jid,NEED_PHOTO, MessageType.text);
...
await heroku.patch(baseURI + '/config-vars', { 
    ...
    await message.client.sendMessage(message.jid, '*' + SUCC_BYE + '*', MessageType.text)
    })
}));
cobra.addCommand({pattern: 'setalive$', fromMe: true, desc: PP_DESC, dontAddCommandList: true}, (async (message, match) => {    
...
cobra.addCommand({pattern: 'setlogopk$', fromMe: true, desc: PP_DESC, dontAddCommandList: true}, (async (message, match) => {    
    if (!message.reply_message || !message.reply_message.image) return await message.client.sendMessage(message.jid,NEED_PHOTO, MessageType.text);
...
await heroku.patch(baseURI + '/config-vars', { 
    ...
    await message.client.sendMessage(message.jid, '*' + SUCC_LGOPK + '*', MessageType.text)
    })
}));
