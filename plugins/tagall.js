...
cobra.addCommand({pattern: 'tagall ?(.*)', fromMe: true, desc: Lang.TAGALL_DESC }, (async (message, match) => {
...
cobra.addCommand({pattern: 'stam$', fromMe: true, desc: stag_dsc }, (async (message, match) => {
