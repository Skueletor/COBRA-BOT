...
cobra.addCommand({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
cobra.addCommand({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC, dontAddCommandList: true}, (async (message, match) => {     
    if (!AFK.isAfk) {
